...
**React Bookstore** is a single page appliation that showcases a list of books. The books can be added and removed from the list. It was built using react and redux.
...
```sh
  cd my-folder
  git clone https://github.com/Timbar09/React-Bookstore.git
```
...
- Follow the steps below
  ...
  - Visit this link "https://github.com/Timbar09/React-Bookstore.git"
